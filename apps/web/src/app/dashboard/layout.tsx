  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex h-8 w-8 items-center justify-center overflow-hidden rounded-full border border-white/10 bg-[#111111] text-xs font-semibold text-zinc-200"
      >
        ...
        <>
          ...
          <div className="absolute right-0 z-50 mt-2 w-56 rounded-md border border-white/10 bg-[#111111] p-1 shadow-2xl shadow-black/40">
            ...
            <button
              ...
              className="mt-1 flex w-full items-center gap-2 rounded-md px-3 py-2 text-left text-xs text-zinc-300 transition hover:bg-white/5 hover:text-white"
            >
          ...
          <header className="sticky top-0 z-30 border-b border-white/10 bg-[#0a0a0a]/95 backdrop-blur">
            <div className="flex h-12 items-center gap-3 px-4 md:px-6 lg:px-8">
              ...
              <div className="ml-auto flex items-center gap-2">
                <label className="hidden h-8 items-center gap-2 rounded-md border border-white/10 bg-[#111111] px-2 text-xs text-zinc-400 sm:flex">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    <circle cx="11" cy="11" r="8" />
                    <line x1="21" y1="21" x2="16.65" y2="16.65" />
                  </svg>
                  <span>Search</span>
                  <span className="rounded border border-white/10 bg-black px-1.5 py-0.5 text-[10px] text-zinc-500">⌘K</span>
                </label>

                <Link
                  href="/dashboard/simulations?new=1"
                  className="hidden h-8 items-center rounded-md bg-[#00C896] px-3 text-xs font-semibold text-black transition hover:bg-[#0fd7a4] md:inline-flex"
                >
                  + Run Simulation
                </Link>
